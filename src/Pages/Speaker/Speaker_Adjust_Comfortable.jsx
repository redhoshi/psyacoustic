...
function Speaker_Adjust_Comfortable() {
   ...
   useEffect(() => {
     const handleMessage = (event) => {
       if (event.data === 'experiment_finished') {  // finish adjust experiment
         ...
         console.log('finish experiment',data)
         data.speaker_VOL = false;
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden', border: '0.5px solid black' }}>
      ...
      <iframe
        ref = {iframeRef}
        src="https://sym.cs-ninhyou.com/exp/speaker_loudness.html" // 埋め込みたいウェブページのURLを指定
...
export default Speaker_Adjust_Comfortable;