...
function Wireless_Pleasantness() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden', border: '0.5px solid black' }}>
      ...
      <iframe
         ref={iframeRef}
        src="https://sym.cs-ninhyou.com/exp/wireless_pleasantness_async.html" // 埋め込みたいウェブページのURLを指定
        title="Pleasantness"
...
export default Wireless_Pleasantness;
