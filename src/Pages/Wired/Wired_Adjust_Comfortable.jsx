...
function Wired_Adjust_Comfortable() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden', border: '0.5px solid black' }}>
      ...
      <iframe
        ref = {iframeRef}
        src="https://sym.cs-ninhyou.com/exp/wired_loudness.html" // 埋め込みたいウェブページのURLを指定
...
export default Wired_Adjust_Comfortable;